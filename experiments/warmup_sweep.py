...
def main():
    ...
    total_runs = len(WARMUP_VALUES) * len(SEEDS)
    run_no = 0
    ...
    for warmup in WARMUP_VALUES:
        for seed in SEEDS:
            ...
            _, _, _, _, summ, register = tr_multi(
                n_eps=N_EPS,
                seed=seed,
                budget=BUDGET,
                max_steps=MAX_STEPS,
            ...
            rows.append({
                ...
                "register_episodes": register.episodes_seen,
            })
    ...
    out_path = out_dir / "warmup_sweep.csv"
